...
<div class="max-w-5xl mx-auto py-8 px-4">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('tables.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg font-semibold shadow flex items-center gap-2 transition">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-blue-50 transition">
                        <td class="px-6 py-4 font-semibold text-gray-800"><?php echo e($table->number); ?></td>
                        <td class="px-6 py-4 text-gray-700"><?php echo e($table->seats); ?></td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 flex gap-2">
                            <a href="<?php echo e(route('tables.edit', $table)); ?>" class="bg-yellow-400 hover:bg-yellow-500 text-white px-3 py-1 rounded shadow text-xs font-bold transition">Edit</a>
                            <form action="<?php echo e(route('tables.destroy', $table)); ?>" method="POST" onsubmit="return confirm('Delete this table?')">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\research\Restaurantbooking\resources\views/tables/index.blade.php ENDPATH**/ ?>