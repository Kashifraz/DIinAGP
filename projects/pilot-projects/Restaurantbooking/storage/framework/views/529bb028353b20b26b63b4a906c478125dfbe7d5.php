...
<div class="max-w-6xl mx-auto py-8 px-4">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('payments.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg font-semibold shadow flex items-center gap-2 transition">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-blue-50 transition">
                        <td class="px-6 py-4 font-semibold text-gray-800">#<?php echo e($payment->order->id ?? '-'); ?></td>
                        <td class="px-6 py-4 text-gray-700">$<?php echo e(number_format($payment->amount, 2)); ?></td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-gray-700"><?php echo e($payment->method); ?></td>
                        <td class="px-6 py-4 text-gray-700"><?php echo e($payment->transaction_id); ?></td>
                        <td class="px-6 py-4 flex gap-2">
                            <a href="<?php echo e(route('payments.edit', $payment)); ?>" class="bg-yellow-400 hover:bg-yellow-500 text-white px-3 py-1 rounded shadow text-xs font-bold transition">Edit</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\research\Restaurantbooking\resources\views/payments/index.blade.php ENDPATH**/ ?>